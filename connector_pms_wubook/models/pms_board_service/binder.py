...
class ChannelWubookPmsBoardServiceBinder(Component):
    _name = "channel.wubook.pms.board.service.binder"
    ...
    # TODO: almost identical code as on room type and room class -> Unify
