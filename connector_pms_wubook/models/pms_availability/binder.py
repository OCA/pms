...
class ChannelWubookPmsAvailabilityBinder(Component):
    _name = "channel.wubook.pms.availability.binder"
    _inherit = "channel.wubook.binder"

    _apply_on = "channel.wubook.pms.availability"

    # _internal_alt_id = ("room_type_id", "date", "pms_property_id")
    # _external_alt_id = ("id_room", "date")
